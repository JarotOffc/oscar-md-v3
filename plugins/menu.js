...
let handler = async (m, { conn, usedPrefix: _p, args, command }) => {
  ...
  let arrayMenu = ['all', 'absen', 'rpg', 'game', 'xp', 'sticker', 'kerang', 'quotes', 'admin', 'group', 'internet','anonymous', 'donwloader', 'berita', 'tools', 'fun', 'database', 'vote', 'catatan','jadian','islami','owner','info','maker','nsfw','premium','asupan']
